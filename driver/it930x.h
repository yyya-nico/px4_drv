...
enum it930x_uart_baudrate {
	...
	IT930X_UART_BAUDRATE_57600 = 245,
	IT930X_UART_BAUDRATE_115200 = 250,
};
...
int it930x_bcas_get_data(struct it930x_bridge *it930x,
			u8 *buf, u8 *len);
int it930x_bcas_send_data(struct it930x_bridge *it930x,
			 u8 *buf, u8 len);
